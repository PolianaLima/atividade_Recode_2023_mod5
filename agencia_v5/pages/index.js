...
import destinobanner from "@/pages/pesquisa/[destinobanner]";
      ...
      <main>
        ...
        <div className="container-sm mt-5 mb-5">
          ...
          <div className="row row-sm-cols-3">
            <Link href="/pesquisa/[codigobanner]" as={`/pesquisa/${encodeURIComponent('Rio de Janeiro')}`} className="col-sm mb-3">
              <img className="w-100" src="/img/viagem_rio_janeiro.jpg" />
            </Link>

            <Link href="/pesquisa/[codigobanner]" as={`/pesquisa/${encodeURIComponent('Fernando de Noronha')}`} className="col-sm mb-3">
